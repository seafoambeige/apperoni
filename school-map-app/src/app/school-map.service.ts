  ...
  public getMap( floorNum: number): [Room] {
    if ( floorNum === SchoolMapService.FIRST_FLOOR ) {
      return [
        ...
        new  Room('boys locker ', 292, 412, 320, 179),
        new  Room('girls locker ', 448, 346, 163, 64),
        new  Room('trainers room ', 290, 249, 54, 52),
        ...
        new  Room('mech room', 819, 183, 63, 47),
        new  Room('210 ', 882, 183, 84, 46),
        new  Room('211 ', 965, 185, 83, 42),
        new  Room('212 ', 1049, 186, 89, 42),
        new  Room('213 ', 1136, 184, 79, 44),
        new  Room('214 ', 1213, 185, 83, 42),
        new  Room('215 ', 1299, 187, 82, 45),
