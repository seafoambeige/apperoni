  ...
  public getMap( floorNum: number): Map {
    if ( floorNum === SchoolMapService.FIRST_FLOOR ) {
      return new Map('1st Floor', [
        ...
        new Room('Auxillary Gym', 66, 43, 26, 10,[],'Normal'),
        ...
        new Room('265', 75, 19, 9, 3,[],'Normal'),
        new Room('266', 75, 22, 9, 4,[],'Normal'),
        new Room('267', 75, 26, 9, 5,[],'Normal'),
        new Room('275', 75, 31, 12, 4,[],'Normal'),
        new Room('281', 75, 37, 12, 4,[],'Normal'),
        new Room('283', 87, 37, 12, 4,[],'Normal'),
        new Room('248', 87, 33, 12, 4,[],'Normal'),
        new Room('mech4', 84, 28, 9, 3,[],'Normal'),

        new Room('120', 58, 69, 11, 6,[],'Normal'),

        new Room('251', 75, 6, 7, 5,[],'Normal'),
        new Room('252', 82, 6, 8, 5,[],'Normal'),
        new Room('255', 90, 6, 7, 4,[],'Normal'),
        new Room('253', 90, 10, 7, 4,[],'Normal'),
        new Room('260', 90, 14, 7, 4,[],'Normal'),
        new Room('262', 83, 14, 7, 4,[],'Normal'),
        new Room('264', 75, 14, 8, 4,[],'Normal'),
        new Room('288', 75, 11, 15, 3,[],'Normal'),
        new Room('MDF2', 97, 15, 3, 3,[],'Normal'),

        new Room('204', 121, 14, 8, 3,[],'Normal'),
        new Room('205', 121, 11, 8, 3,[],'Normal'),
        new Room('Courtyard6', 101, 10, 20, 3,[],'Normal'),
        new Room('206', 121, 6, 8, 5,[],'Normal'),
        new Room('207', 116, 6, 6, 4,[],'Normal'),
        new Room('208', 108, 6, 8, 4,[],'Normal'),
        new Room('209', 100, 6, 8, 4,[],'Normal'),
        new Room('200', 101, 13, 5, 4,[],'Normal'),
        new Room('201', 106, 13, 5, 4,[],'Normal'),
        new Room('202', 111, 13, 5, 4,[],'Normal'),
        new Room('203', 116, 13, 5, 4,[],'Normal'),

        new Room('221', 134, 7, 9, 11,[],'Normal'),
        new Room('226', 117, 19, 5, 3,[],'Normal'),
        new Room('228', 117, 22, 5, 3,[],'Normal'),
        new Room('230', 117, 25, 5, 3,[],'Normal'),
        new Room('232', 109, 30, 6, 3,[],'Normal'),
        new Room('234', 114, 28, 8, 5,[],'Normal'),
        new Room('235', 109, 28, 5, 2,[],'Normal'),
        new Room('240/241', 103, 19, 14, 9,[],'Normal'),


        new Room('225', 125, 18, 18, 5,[],'Normal'),
        new Room('229', 125, 23, 18, 5,[],'Normal'),
        new Room('231', 125, 28, 18, 5,[],'Normal'),
        new Room('stairs1', 125, 33, 10, 2,[],'Normal'),
        new Room('305', 125, 35, 10, 4,[],'Normal'),
        new Room('311', 125, 39, 9, 4,[],'Normal'),
        new Room('313', 125, 43, 9, 4,[],'Normal'),
        new Room('315', 125, 47, 9, 4,[],'Normal'),
        new Room('317', 125, 51, 9, 4,[],'Normal'),
        new Room('319', 125, 55, 9, 4,[],'Normal'),
        new Room('321', 125, 59, 9, 4,[],'Normal'),
        new Room('stairs2', 125, 64, 9, 3,[],'Normal'),

        new Room('Courtyard5', 103, 33, 10, 10,[],'Normal'),
        new Room('boys br1', 113, 33, 9, 2,[],'Normal'),
        new Room('girls br1', 113, 35, 9, 2,[],'Normal'),
        new Room('fake 322', 113, 37, 9, 3,[],'Normal'),
        new Room('312', 113, 40, 9, 3,[],'Normal'),

        new Room('Courtyard4', 103, 45, 10, 8,[],'Normal'),
        new Room('314', 113, 45, 9, 4,[],'Normal'),
        new Room('316', 113, 49, 9, 4,[2,2],'Normal'),
        new Room('318', 113, 55, 9, 4,[],'Normal'),
        new Room('320', 113, 59, 9, 4,[],'Normal'),
        new Room('322', 113, 63, 9, 4,[],'Normal'),
